...
Therefore, this is the core package layout, assuming github.com/ln-12/go-sdk as the module path.

- `github.com/ln-12/go-sdk/mcp`: the bulk of the user facing API
- `github.com/ln-12/go-sdk/jsonschema`: a jsonschema implementation, with validation
- `github.com/ln-12/go-sdk/internal/jsonrpc2`: a fork of x/tools/internal/jsonrpc2_v2
...
Rate limiting can be configured using middleware. Please see [examples/rate-limiting](<https://github.com/ln-12/go-sdk/tree/main/examples/rate-limiting>) for an example on how to implement this.
...
The SDK will be hosted under github.com/ln-12/go-sdk, MIT license, copyright "Go SDK Authors". Each Go file in the repository will have a standard copyright header. For example:
